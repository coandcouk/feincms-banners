...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('feincms_banners_banner_sites', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('banner', models.ForeignKey(orm['feincms_banners.banner'], null=False)),
            ('site', models.ForeignKey(orm['sites.site'], null=False))
        ))
        db.create_unique('feincms_banners_banner_sites', ['banner_id', 'site_id'])


    def backwards(self, orm):
        # Deleting field 'Banner.target'
        db.delete_column('feincms_banners_banner', 'target')

        # Removing M2M table for field sites on 'Banner'
        db.delete_table('feincms_banners_banner_sites')
    ...
    models = {
        ...
        'feincms_banners.click': {
            'Meta': {'ordering': "[u'-timestamp']", 'object_name': 'Click'},
            'banner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'clicks'", 'to': "orm['feincms_banners.Banner']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ip': ('django.db.models.fields.IPAddressField', [], {'max_length': '15', 'null': 'True', 'blank': 'True'}),
            'referrer': ('django.db.models.fields.TextField', [], {'default': "u''", 'blank': 'True'}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'user_agent': ('django.db.models.fields.TextField', [], {'default': "u''", 'blank': 'True'})
        },
